...
sys.path.insert(0, os.path.join(os.path.dirname(__file__), "..", "..", "..", "..", "examples", "google_adk"))
...
APPROVED_HANDLE_PATTERNS = ["adk-qa-*", "qa-*"]
...
async def main() -> None:
    ...
    logger.info("Starting ADK contacts agent (strategy=CALLBACK, broadcast=True)...")
    await agent.run()
