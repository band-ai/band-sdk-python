...
def _build_copilot_sdk(
    ...
    *,
    ...
    from band.adapters.copilot_sdk import (  # noqa: PLC0415 -- isolates the copilot_sdk extra from the other frameworks this file builds
        CopilotSDKAdapter,
...
def _build_langgraph(
    ...
    *,
    ...
    from langchain_openai import (  # noqa: PLC0415 -- isolates the langgraph extra from the other frameworks this file builds
        ChatOpenAI,
    )
    from langgraph.checkpoint.memory import (  # noqa: PLC0415 -- isolates the langgraph extra from the other frameworks this file builds
        MemorySaver,
    )
...
def _build_pydantic_ai(
    ...
    *,
    ...
    from pydantic_ai import (  # noqa: PLC0415 -- isolates the pydantic_ai extra from the other frameworks this file builds
        RunContext,
    )
...
def _build_strands(
    ...
    *,
    ...
    from strands.models.openai import (  # noqa: PLC0415 -- isolates the strands extra from the other frameworks this file builds
        OpenAIModel,
    )
...
def _build_agno(
    ...
    *,
    ...
    from agno.agent import (  # noqa: PLC0415 -- isolates the agno extra from the other frameworks this file builds
        Agent as AgnoAgent,
    )
    from agno.models.anthropic import (  # noqa: PLC0415 -- isolates the agno extra from the other frameworks this file builds
        Claude,
    )

    from band.adapters.agno import (  # noqa: PLC0415 -- isolates the agno extra from the other frameworks this file builds
        AgnoAdapter,
    )
...
def _build_opencode(
    ...
    *,
    ...
    from band.adapters.opencode import (  # noqa: PLC0415 -- isolates the opencode extra from the other frameworks this file builds
        OpencodeAdapter,
...
def _build_letta(
    ...
    *,
    ...
    from band.adapters.letta import (  # noqa: PLC0415 -- isolates the letta extra from the other frameworks this file builds
        LettaAdapter,
        LettaAdapterConfig,
        LettaMCPConfig,
    )
