...
def flattened_markdown(path: Path) -> str:
    """File text as one space-joined line without emphasis/backtick markup."""
...
def _observe_variant(variant: str) -> VariantIdentity:
    readme = flattened_markdown(ROOT / variant / "README.md")
