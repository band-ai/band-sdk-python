...
# copilot_acp and omp_acp are thin ACPClientAdapter subclasses: they share the
# excluded acp bridge's lifecycle and converter and add no model/LLM contract of
# their own, so they are exercised live through the baseline backend lane instead.
