...
# copilot_acp and cursor_acp are thin ACPClientAdapter subclasses. They share the
# excluded acp bridge's lifecycle and converter, so the baseline matrix exercises
# them live instead of the framework-conformance matrix.
...
_excluded = {"a2a", "a2a_gateway", "acp", "copilot_acp", "cursor_acp", "slack"}
if not _HAS_CLAUDE_SDK:
