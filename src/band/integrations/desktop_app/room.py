...
class RoomEvent(RoomTranscript):
    ...
    def tick(self) -> RoomEvent:
        ...
        Shed fields go out empty, meaning "unchanged"; the view restores them
        from its cache (``kept`` in ``assets/room-view.js``). Shedding a new
        field here means teaching that function about it too.
        """
