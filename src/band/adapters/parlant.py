...
class ParlantAdapter(SimpleAdapter[ParlantMessages]):
    ...
    async def on_started(self, agent_name: str, agent_description: str) -> None:
        ...
        try:
            ...
            await self._install_band_contract_guideline()
            logger.info(
    ...
    async def _install_band_contract_guideline(self) -> None:
        ...
        guideline = await self._parlant_agent.create_guideline(
            ...
            action=(
                ...
                "Communicate through band_send_message with the intended "
    ...
    async def _get_or_create_customer(
        ...
        customer_id = f"band-{hashlib.sha256(room_id.encode('utf-8')).hexdigest()[:32]}"
