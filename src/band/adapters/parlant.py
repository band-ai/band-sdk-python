...
class ParlantAdapter(SimpleAdapter[ParlantMessages]):
    ...
    async def _prepare_server(
        ...
        from parlant.core.application import Application  # type: ignore[missing-import]  # noqa: PLC0415
    ...
    async def on_message(
        ...
        *,
        ...
        try:
            from parlant.core.app_modules.sessions import Moderation  # type: ignore[missing-import]  # noqa: PLC0415
            from parlant.core.sessions import EventSource  # type: ignore[missing-import]  # noqa: PLC0415
    ...
    async def _inject_history(
        ...
        app = self._app
        from parlant.core.app_modules.sessions import Moderation  # type: ignore[missing-import]  # noqa: PLC0415
        from parlant.core.sessions import EventKind, EventSource  # type: ignore[missing-import]  # noqa: PLC0415
    ...
    async def _process_agent_response(
        ...
        app = self._app
        session_id_str = str(session_id)
        from parlant.core.async_utils import Timeout  # type: ignore[missing-import]  # noqa: PLC0415
        from parlant.core.sessions import EventKind, EventSource  # type: ignore[missing-import]  # noqa: PLC0415
