...
def _silence_lite_agent_error_panel() -> None:
    ...
    try:
        ...
        from crewai.events.event_listener import event_listener  # noqa: F401, PLC0415
        from crewai.events.types.agent_events import LiteAgentExecutionErrorEvent  # noqa: PLC0415
...
class CrewAIAdapter(SimpleAdapter[CrewAIMessages]):
    ...
    async def on_started(self, agent_name: str, agent_description: str) -> None:
        ...
        try:
            from crewai import Agent as CrewAIAgent  # noqa: PLC0415
