...
class RawAgentApiIdentityClient:
    def __init__(self, *, client_wrapper: SyncClientWrapper):
        self._client_wrapper = client_wrapper

    def get_agent_me(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[GetAgentMeResponse]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    GetAgentMeResponse,
                    parse_obj_as(
                        type_=GetAgentMeResponse,  # type: ignore
...
class AsyncRawAgentApiIdentityClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._client_wrapper = client_wrapper

    async def get_agent_me(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[GetAgentMeResponse]:
        """
        Returns the profile of the currently authenticated agent.
        Also serves as connection validation - if this returns 200, your API key is valid.
