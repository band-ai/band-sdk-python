...
from .raw_client import AsyncRawAgentApiMessagesClient, RawAgentApiMessagesClient
...
class AgentApiMessagesClient:
    def __init__(self, *, client_wrapper: SyncClientWrapper):
        self._raw_client = RawAgentApiMessagesClient(client_wrapper=client_wrapper)

    @property
    def with_raw_response(self) -> RawAgentApiMessagesClient:
        """
        Retrieves a raw implementation of this client that returns raw responses.

        Returns
        -------
        RawAgentApiMessagesClient
        """
    ...
    def list_agent_messages(
        ...
        **Important:** Always call `/processing` before starting work. This prevents
        ...
        client.agent_api_messages.list_agent_messages(
            chat_id="chat_id",
            status="pending",
            page=1,
            page_size=1,
    ...
    def get_agent_next_message(
        ...
        client.agent_api_messages.get_agent_next_message(
            chat_id="chat_id",
        )
        """
        _response = self._raw_client.get_agent_next_message(
    ...
    def mark_agent_message_processing(
        ...
        *,
        ...
        client.agent_api_messages.mark_agent_message_processing(
            chat_id="chat_id",
            id="id",
        )
        """
        _response = self._raw_client.mark_agent_message_processing(
    ...
    def mark_agent_message_failed(
        ...
        **Requires an active processing attempt.** You must call `/processing` first.
        ...
        client.agent_api_messages.mark_agent_message_failed(
            chat_id="chat_id",
            id="id",
            error="error",
        )
    ...
    def mark_agent_message_processed(
        ...
        **Requires an active processing attempt.** You must call `/processing` first.
        ...
        """
        _response = self._raw_client.mark_agent_message_processed(
            chat_id, id, request_options=request_options
        )
        return _response.data


class AsyncAgentApiMessagesClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._raw_client = AsyncRawAgentApiMessagesClient(client_wrapper=client_wrapper)

    @property
    def with_raw_response(self) -> AsyncRawAgentApiMessagesClient:
        """
        Retrieves a raw implementation of this client that returns raw responses.

        Returns
        -------
        AsyncRawAgentApiMessagesClient
        """
        return self._raw_client
    ...
    async def list_agent_messages(
        ...
        **Important:** Always call `/processing` before starting work. This prevents
        ...
        async def main() -> None:
            await client.agent_api_messages.list_agent_messages(
                chat_id="chat_id",
                status="pending",
                page=1,
                page_size=1,
    ...
    async def get_agent_next_message(
        ...
        async def main() -> None:
            await client.agent_api_messages.get_agent_next_message(
                chat_id="chat_id",
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.get_agent_next_message(
            chat_id, request_options=request_options
        )
        return _response.data
    ...
    async def mark_agent_message_processing(
        ...
        *,
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.mark_agent_message_processing(
            chat_id, id, request_options=request_options
        )
        return _response.data
    ...
    async def mark_agent_message_failed(
        ...
        **Requires an active processing attempt.** You must call `/processing` first.
        ...
        async def main() -> None:
            await client.agent_api_messages.mark_agent_message_failed(
                chat_id="chat_id",
                id="id",
                error="error",
            )
    ...
    async def mark_agent_message_processed(
        ...
        **Requires an active processing attempt.** You must call `/processing` first.
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.mark_agent_message_processed(
            chat_id, id, request_options=request_options
        )
        return _response.data
