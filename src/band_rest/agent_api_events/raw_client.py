...
class RawAgentApiEventsClient:
    ...
    def create_agent_chat_event(
        ...
        *,
    ...
    ) -> HttpResponse[CreateAgentChatEventResponse]:
        """
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"api/v1/agent/chats/{jsonable_encoder(chat_id)}/events",
            method="POST",
            json={
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=CreateAgentChatEventResponse,  # type: ignore
...
class AsyncRawAgentApiEventsClient:
    ...
    async def create_agent_chat_event(
        ...
        *,
        event: ChatEventRequest,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[CreateAgentChatEventResponse]:
        """
        Creates a new event in a chat room.
